...
cur_dir=`pwd`
def_dir="/root"
soga_lisence="7ASmraL9eDO2qdnejHj1FkhOx946OWA6"
soga_web="https://qinqin666.com"
soga_keey="www.qinqin666.com"
# Color
red='\033[0;31m'
green='\033[0;32m'
yellow='\033[0;33m'
...
config_soga_v2ray()
{
    ...
    echo "docker run --restart=on-failure --name ${container_name} -d -v /yaoyue/soga/v2ray/${container_name}/etc/soga/:/etc/soga/ --network host -e type=v2board -e server_type=v2ray -e api=webapi -e webapi_url=${soga_web} -e webapi_key=${soga_keey} -e node_id=${node_id} -e soga_key=${soga_lisence} vaxilu/soga" > ./command.sh
